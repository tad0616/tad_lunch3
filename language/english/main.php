...
define('_MD_TAD_LUNCH3_LUNCH', 'Lunch');
define('_MD_TAD_LUNCH3_INFO', 'Information');
define('_MD_TAD_LUNCH3_KITCHEN', 'Vendor:');
...
define('_MD_TAD_LUNCH3_NO_RESPONSE', 'No response information available:');
define('_MD_TAD_LUNCH3_UNABLE_TO_PARSE', 'Unable to parse response data:');
